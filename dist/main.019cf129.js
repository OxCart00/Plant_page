    ...
    6: [
      function (require, module, exports) {
        ...
        function s(e, o, l) {
          ...
          console.log(a);
          var n = new t.default({ plant: a.plant, soil: a.soil, pot: a.pot });
        ...
        function i() {
          ...
          if (n.checkValidity()) {
            ...
            if (e.length >= 5) {
              var l = e[0],
                i = "clay-pot" === e[3] ? "clay-pot" : "other-pot";
              console.log(l, e[2], i, e[4], e);
              var d = s(e, l, i);
              localStorage.setItem("plant-info", JSON.stringify(d)),
                (0, o.sheetBuilder)();
            }
          } else
            alert(
      ...
      { "./plant-builder.js": 9, "./info-sheet.js": 10, "../config.js": 8 },
    ],
    5: [
      function (require, module, exports) {
        "use strict";
...
//# sourceMappingURL=/main.019cf129.map
