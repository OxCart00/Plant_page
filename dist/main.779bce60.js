      ...
      function (require, module, exports) {
        ...
        function sheetBuilder() {
          ...
          if (plantInfo.pot === "simple-ceramic-too") {
            ...
            if (plantInfo.color) {
              potImg.src =
                "../images/" + plantInfo.color + "-" + plantInfo.pot + ".png";
            } else {
        ...
        function formObject() {
          ...
          if (formulario.checkValidity()) {
            ...
            if (selectedIds.length >= 5) {
              ...
              var potType =
                selectedIds[3] === "clay-pot" ? "clay-pot" : "other-pot";

              var newPlant = createRecommendation(
                selectedIds,
                plantType,
                potType,
              );
