      ...
      function (require, module, exports) {
        ...
        function e() {
          ...
          "simple-ceramic-too" === e.pot
            ? (p.src = "./assets/images/simple-ceramic-pot.png")
            : (p.src = "./assets/images/" + e.pot + ".png"),
            a.appendChild(p);
          var o = document.createElement("img");
          (o.src = "./assets/images/soil-" + e.soil + ".png"), a.appendChild(o);
          var i = document.createElement("img");
          (i.src = "./assets/images/plant-" + e.plant + ".png"),
            a.appendChild(i),
            t.appendChild(a);
          ...
          if (d.checkValidity()) {
            ...
            if (e.length >= 5) {
              ...
              for (var i = 5; i < e.length; i++)
                "moss-pole" === e[i] && l.addMoss(),
                  "pebbles" === e[i] && l.addPebbles(),
                  "mini-plants" === e[i] && l.addGreenies();
...
//# sourceMappingURL=/main.82f7fc7e.map
