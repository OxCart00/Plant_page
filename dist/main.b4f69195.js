        ...
        function e() {
          ...
          if (
            ...
            if (((l.textContent = "Extras: "), e.greenies)) {
              ...
              (s.src = "images/plant-" + e.greenies + ".png"), a.appendChild(s);
            } else if (e.pebbles) {
              l.textContent += e.pebbles;
              var g = document.createElement("img");
              (g.src = "images/plant-" + e.pebbles + ".png"), a.appendChild(g);
            } else if (e.moss) {
              l.textContent += e.moss;
              var C = document.createElement("img");
              (C.src = "images/plant-" + e.moss + ".png"), a.appendChild(C);
            }
            r.appendChild(l);
          }
...
//# sourceMappingURL=/main.b4f69195.map
