      ...
      function (require, module, exports) {
        ...
        function e() {
          ...
          "simple-ceramic-too" === e.pot
            ...
            ? (p.src = "images/painted-decorated-ceramic-pot.png")
            : (p.src = "images/" + e.pot + ".png"),
            a.appendChild(p);
          var i = document.createElement("img");
          (i.src = "images/soil-" + e.soil + ".png"), a.appendChild(i);
          var o = document.createElement("img");
          (o.src = "images/plant-" + e.plant + ".png"), a.appendChild(o);
          var r = document.createElement("div"),
            c = document.createElement("p");
          (c.textContent = "Name: " + e.plant), r.appendChild(c);
          var m = document.createElement("p");
          (m.textContent = "Soil: " + e.soil), r.appendChild(m);
          var d = document.createElement("p");
          if (
            ((d.textContent = "Pot: " + e.pot),
            r.appendChild(d),
            ...
            if (((l.textContent = "Extras: "), e.greenies)) {
              ...
              (s.src = "images/" + e.greenies + ".png"), a.appendChild(s);
            } else if (e.pebbles) {
              l.textContent += e.pebbles;
              var g = document.createElement("img");
              (g.src = "images/" + e.pebbles + ".png"), a.appendChild(g);
            } else if (e.moss) {
              l.textContent += e.moss;
              var C = document.createElement("img");
              (C.src = "images/" + e.moss + ".png"), a.appendChild(C);
            }
            r.appendChild(l);
          }
...
//# sourceMappingURL=/main.ba394bb1.map
